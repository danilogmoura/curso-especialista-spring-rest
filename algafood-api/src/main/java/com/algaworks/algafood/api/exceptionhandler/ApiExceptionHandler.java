...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro inesperado no sistema. Tente novamente e se o problema persistir " +
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String detail = String.format("O parâmetro '%s' recebeu o valor '%s', que é um tipo inválido. " +
                "Corrija e informe um valor compátivel com o tipo %s", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
    ...
    private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String detail = String.format("A propriedade '%s' recebeu p valor '%s', que é de um tipo inválido. " +
    ...
    public ResponseEntity<?> handleUncaught(Exception ex, WebRequest request) {
        ...
        // Se não fizer isso, não vamos ver o stacktrace de exceptions que são importantes
